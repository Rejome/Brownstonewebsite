...
class Products extends CI_Controller {
	...
	public function viewdocs(){
		$this->load->view('brownstone/products/viewdocs.php');
	}
	...
	public function suppliers($supplierId = null, $typeId = null) {
		...
		if($supplierId != null) {
			...
			$this->data['product_content'] = $this->load->view('brownstone/products/suppliers.php', $this->data, true);
		}
	...
	public function types($category = null, $typeId = null) {
		...
		if($typeId != null) {
			...
			$this->data['industryList'] = $this->getData('industries');
			$this->data['supplierList'] = $this->getData('suppliers');
			$this->data['product_content'] = $this->load->view('brownstone/products/productsSelected.php', $this->data, true);
		} else {
			$this->data['product_content'] = $this->load->view('brownstone/products/products.php', $this->data, true);
		}
	...
	public function product() {
		$this->data['content'] = $this->load->view('brownstone/products.php', $this->data, true);
